...
CREATE TABLE "purchasingRfqLine" (
  ...
  CONSTRAINT "purchasingRfqLine_unitOfMeasureCode_fkey" FOREIGN KEY ("unitOfMeasureCode", "companyId") REFERENCES "unitOfMeasure" ("code", "companyId") ON DELETE RESTRICT,
